...
from .pretrained_transformer_embedder_with_dropout import (
    PretrainedTransformerEmbedderWithDropout,
)


@TokenEmbedder.register("pretrained_transformer_mismatched_with_dropout")
class PretrainedTransformerMismatchedEmbedder(TokenEmbedder):
    ...
    def __init__(
        ...
        self._matched_embedder = PretrainedTransformerEmbedderWithDropout(
            model_name,
    ...
    def forward(
        ...
        orig_embeddings[
            (span_embeddings_len == 0).expand(orig_embeddings.shape)
        ] = 0
