...
class CSVMaker(object):
    ...
    def save(self, csv_file_name, encoding=None):
        df = pd.DataFrame.from_dict(self.data)
        df.to_csv(csv_file_name, encoding=encoding)

    def save_excel(self, csv_file_name, encoding=None):
        df = pd.DataFrame.from_dict(self.data)
        df.to_excel(csv_file_name, encoding=encoding)
