...
class DataArguments:
    ...
    codemix_ratio_query: float = field(default=0.0)
    codemix_ratio_document: float = field(default=0.0)
    codemix_sentence_ratio: float = field(default=0.0)
    codemix_sentence_ratio_query: float = field(default=0.0)
    codemix_sentence_ratio_document: float = field(default=0.0)
    codemix_set: str = field(default='en-ko')
    codemix_in_runtime: bool = field(default=True)
    cm_loss_weight: float = field(default=0.0)
    cm_loss_weight_query: float = field(default=0.0)
    cm_loss_weight_document: float = field(default=0.0)
