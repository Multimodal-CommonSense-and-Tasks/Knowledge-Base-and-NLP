...
class AdapterTrainer(Trainer):
    ...
    def _save_tpu(self, output_dir: Optional[str] = None):
        ...
        if not isinstance(self.model, PreTrainedModel):
            ...
            # should not use xm.is_master_ordinal(), since xm.save uses xm.randevous again.. which waits for other hosts.
            # xm.save is needed, since it sends xla to cpu https://github.com/pytorch/xla/blob/815197139b94e5655ed6b347f48864e73dc73011/torch_xla/core/xla_model.py#L799
            ...
            if hasattr(self.args, 'save_model_also'):
                if self.args.save_model_also:
...
class AdapterTrainerCallback(TrainerCallback):
    ...
    def on_step_end(self, args: TrainingArguments, state: TrainerState, control: TrainerControl, **kwargs):
        ...
        if self.trainer.train_adapter_fusion:
            ...
            if not isinstance(fusion_reg_loss, float):
