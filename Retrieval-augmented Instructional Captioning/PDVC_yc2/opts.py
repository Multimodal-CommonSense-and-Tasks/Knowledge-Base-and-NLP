...
def parse_opts():
    ...
    parser.add_argument('--input_encoding_size', type=int, default=768,
                        help='the encoding size of each token in the vocabulary')
    parser.add_argument('--att_hid_size', type=int, default=768, help='the hidden size of the attention MLP')
    ...
    parser.add_argument('--base_encoder',  action='store_true', help='use cnn base encoder')
    ...
    parser.add_argument('--cap_nheads', default=12, type=int)
    parser.add_argument('--cap_dec_n_points', default=4, type=int)
    parser.add_argument('--cap_num_feature_levels', default=1, type=int)#default=4
